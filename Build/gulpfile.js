...
Serve and watch
------------------------------------ */
gulp.task('default', gulp.series('processCss', 'processJs', 'copyFonts', 'copyImages', (done) => {
    connect.server({
        // base: './Templates/'
    }, function () {
        browserSync({
...
Watch only
------------------------------------ */
gulp.task('watch', gulp.series('processCss', 'processJs', 'copyFonts', 'copyImages', (done) => {
